...
. Login to your Jenkins instance at https://jenkins-0.some.domain.com with the same username and password that you use for CloudFoundry.
...
. Under *API Endpoint*, enter `https://api.some.domain.com`.
...
. Under *Target*, enter `https://api.some.domain.com`.
